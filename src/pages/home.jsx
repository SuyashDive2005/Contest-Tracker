  ...
  return (
    <div className="pt-24 px-4 bg-gradient-to-b from-indigo-950 via-blue-950 to-purple-950 text-white min-h-screen">
      ...
      <div className="mt-20 text-center">
        <Link
          to="/liveContest"
          className="inline-block bg-yellow-400 hover:bg-orange-400 text-black font-semibold px-10 py-4 rounded-xl transition duration-300 shadow-lg hover:shadow-2xl transform hover:scale-105 text-lg"
        >
